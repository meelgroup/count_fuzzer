...
g_max_num_vars = 30
g_num_vars = 0
g_min_rclauses_perc = 5
g_max_rclauses_perc = 10
g_rclauses_perc = 0
g_min_rclause_len = 2
g_max_rclause_len = 15
g_min_refs = 1
g_id = 0
g_nodes = {}
g_taut = None
...
while len(g_unfinished1) > 0:
  ...
  num += 1
  if num > 30000:
    print("c too many nodes")
    print("p cnf 1 1")
    if gen_type == 0: print("c t mc")
    if gen_type == 1: print("c t pmc")
    if gen_type == 2: print("c t wmc")
    if gen_type == 3: print("c t pwmc")
    print("1 0")
    exit(0)
